...
Далее надо проверить всё ли работает. Для этого заходим в игру, выбираем онлайн режим. Если в онлайне можно создать лобби, зайти в ранговый матч (в случае с файтингами), то это значит, что сервер работает. Других игроков, естественно, пока не будет, так как только мы подключены к серверу, но игра должна позволять запускать онлайн-режимы, а не выкидывать в главное меню.
