...
> :warning: Может быть такое, что команда **git pull** не скачает последнюю версию, и в итоге произойдёт компиляция текущей версии. В этом случае вместо **git pull** нужно вбить **git checkout %ветка последней версии%**. Чтобы узнать, какая ветка нам нужна, необходимо перейти [сюда](https://github.com/RipleyTom/rpcn/releases), найти последнюю версию, слева от неё будет дата обновления, ниже под версией и будет наша ветка (набор из семи символов).  
>
><img width="1161" height="611" alt="Releases · RipleyTom_rpcn - Google Chrome 29 01 2026 5_30_39" src="https://github.com/user-attachments/assets/c274a525-025f-42f0-bffa-5b206b320848" />  
>
